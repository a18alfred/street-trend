...
import { getAllClients } from '../../rest-client/rest/admin';
import {
  deleteOneProduct,
  postNewProduct,
...
} from '../../rest-client/rest/reviews';
import { getAllNewsletterSignups } from '../../rest-client/rest/signup';
  ...
  return async (dispatch: Dispatch<AdminAction>): Promise<void> => {
    ...
    try {
      ...
      dispatch({
        ...
        payload: axiosError?.response?.data || axiosError?.response?.data?.error,
      });
    }
  };
};
